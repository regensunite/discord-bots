  ...
  "embeds": [
    {
      ...
      "description": [
        ...
        `3. Everyone takes ownership of creating a safe and openspace. This means that we're not here to convince others, nor to fight each other. Our goal is to create and learn, be curious, have fun, and support each other to share perspective.`,
